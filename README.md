# Mini Projet Power BI — Analyse des demandes de prêts immobiliers
## 1) Quel était le problème métier ?
...
## 2) Quelle approche technique avez-vous choisie ?
...
## 3) Quels sont les insights (résultats) générés ?
